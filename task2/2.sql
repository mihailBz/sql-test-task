...
(
  ...
  from product_page_view as ppv where ppv.id_user_account in 
  (select tr.id_user_account from [transaction] as tr)
...
inner join product_views as pv on ts.id_product = pv.id_product;